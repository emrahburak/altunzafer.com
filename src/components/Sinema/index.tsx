...
const row2 = [c09, c10, c11, c12, c13, c14, c15, c16,];
      ...
      >
        ...
        <div className="w-full overflow-hidden whitespace-nowrap">
          <div ref={marqueeRef1} className="inline-flex gap-4 w-max">
            {[...row1, ...row1].map((src, i) => (
              <div key={i} className="w-[220px] h-[300px] md:w-[280px] md:h-[380px] shrink-0 rounded-sm overflow-hidden border border-white/10 grayscale hover:grayscale-0 transition-all duration-500 hover:scale-105 cursor-pointer bg-[#111]">
